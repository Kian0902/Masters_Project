...
if __name__ == "__main__":
    ...
    fnn = BranchFNN().to(device)
    dummy = DummyNetwork().to(device)
    
    
    # Apply He initialization
    cnn.apply(he_initialization)
    fnn.apply(he_initialization)
    dummy.apply(he_initialization)
    # combined.apply(he_initialization)

    # Print summaries for individual branches
    print("CNN Branch Summary:")
    summary(cnn, input_size=(3, 81, 81))
    
    print("\nFNN Branch Summary:")
    summary(fnn, input_size=(19,))
    
    
    print("\nComined Summary:")
    summary(dummy, input_size=(128*10*10 + 1024, ))
