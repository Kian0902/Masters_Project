...
fig.suptitle("Supervised", fontsize=20)
...
plt.savefig("Example_Supervised.png", dpi=150, bbox_inches='tight')
plt.show()


# Example Figure Unsupervised
fig, ax = plt.subplots(figsize=(6, 5))
fig.suptitle("Unsupervised", fontsize=20)
...
ax.spines[['left' , 'bottom']].set_linewidth(2)
ax.tick_params(left=False, labelleft=False, bottom=False, labelbottom=False)
plt.savefig("Example_Unsupervised.png", dpi=150, bbox_inches='tight')
plt.show()
